...
programs = {
   ...
   "Ruby Oj (rails mode)":
       {
           "url":"",
           "commands":["/usr/bin/env", "ruby", os.path.join(PARSERS_DIR, "test_oj_rails.rb")]
       },
   "fast_jsonparser":
       {
           "url":"",
           "commands":["/usr/bin/env", "ruby", os.path.join(PARSERS_DIR, "test_fast_jsonparser.rb")]
       },
   "simdjson_ruby":
       {
           "url":"",
           "commands":["/usr/bin/env", "ruby", os.path.join(PARSERS_DIR, "test_simdjson.rb")]
       },
}
